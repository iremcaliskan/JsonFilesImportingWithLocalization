...
namespace Core.CrossCuttingConcerns.Caching.Microsoft
{
    ...
    { // Adapter Pattern
        private readonly IMemoryCache _memoryCache; // Microsoft's
        // Injection of its is in Core Module
        ...
        {
            return _memoryCache.Get(key); // Alternative get
        }
        ...
        { // Remove the Cache by the passesed pattern at run time, Reflection provides manipulation on objects at run time
